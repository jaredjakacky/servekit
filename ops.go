...
//
// A non-nil gate also enables the admin routes. Return nil from the gate to
// allow the request or a Servekit HTTPError to control the denial response. A
// nil gate function is ignored.
